    ...
    <body>
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link" href="previous_approved_rejected.php">Undergoing Leaves</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="previous_approved_rejected_1.php">Completed Leaves</a>
              </li>
            </ul>
