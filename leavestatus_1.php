...
<html>
    ...
    <body>
      ...
      <div class="topbar">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="leavestatus_1.php">Approved/Rejeceted</a>
              </li>
              <li class="nav-item">
     ...
     $query =  mysqli_query($link,("SELECT * FROM `tblleave` WHERE  EMPID = '".$_SESSION['EMPID']."' AND (LEAVESTATUS='APPROVED' OR LEAVESTATUS='REJECTED') ORDER BY LEAVEID DESC "));
    if(isset($query))
    {
  if($query->num_rows >= 1){
...
STAFF;
  ...
  {
    echo '<div class="mt-4">
        <h1 class="text-md text-center">No previous Accepted/Rejected requests are available</h1></div>';
}
} 
