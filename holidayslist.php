...
<html>
    ...
    <body>
      ...
      <div class="topbar">
        ...
        <div class="sidebar">
            ...
            <div id="actions" class="list-group">
                  ...
                  <button type="button" class="list-group-item active list-group-item-action"onclick="location.href='holidayslist.php'">Holidays List</button>
     ...
     $query =  mysqli_query($link,("SELECT * FROM `holydays`"));
    if(isset($query))
    {
  if($query->num_rows >= 1){
