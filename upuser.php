     ...
     <body>
         ...
         <div class="nav">
            ...
            <ul class="nav nav-tabs">
              <li role="presentation" class="active"><a href="upuser.php">Update User Details</a></li>
...
<script type="text/javascript" language="javascript" >
     $(document).ready(function(){
      ...
      $(document).on('click', '#insert', function(){
       var EMPID = $('#data1').text();
       var EMPNAME = $('#data2').text();
       var DEPARTMENT = $('#data3').text();
       var USERNAME = $('#data4').text();
       var PASSWORDS = $('#data5').text();
       var CL = $('#data6').text();
       var EL = $('#data7').text();
       var OD = $('#data8').text();
       var PERMISIONS = $('#data9').text();
       var LOP = $('#data10').text();
       var LATECOMING = $('#data11').text();
       if(EMPID != '' && EMPNAME != '' && DEPARTMENT != '' && USERNAME != '' && PASSWORDS != '' && CL != '' && EL != '' && OD != '' && PERMISIONS != '' && LOP != '' && LATECOMING != '')
       {
        $.ajax({
         url:"insertuser.php",
         method:"POST",
         data:{EMPID:EMPID, EMPNAME:EMPNAME, DEPARTMENT:DEPARTMENT, USERNAME:USERNAME, PASSWORDS:PASSWORDS, CL:CL, EL:EL, OD:OD, PERMISIONS:PERMISIONS, LOP:LOP, LATECOMING:LATECOMING},
         success:function(data)
         {
          $('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
          $('#user_data').DataTable().destroy();
